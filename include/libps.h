...
// exit not defined in any headers.
#define exit( _ARGS_ ) { printf("exit not yet implemented TODO\n"); abort(); } //TODO: 
#define delete( __ARGS__ )  exit( __ARGS__ ) 
#endif
...
// use built-in instead double strtod(char *, char **);
int printf2(char *, ...);
